...
export default function AdminSubcategories() {
  ...
  const createMutation = useMutation({
    ...
    onSuccess: () => {
      ...
      toast.success(t("admin.subcategoryCreated"));
  ...
  const resetForm = () => {
    setFormData({ name: "", category_id: "", display_order: 0, is_active: true });
      ...
      <header className="bg-primary text-primary-foreground p-4 sticky top-0 z-50 safe-area-inset-top">
        <div className="container mx-auto flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <h1 className="text-2xl font-bold">{t("admin.manageSubcategories2")}</h1>
          </div>
        </div>
      </header>
      ...
      <div className="container mx-auto p-6">
        <Card>
          <CardHeader className="flex flex-row items-center justify-between">
            <CardTitle>{t("admin.subcategories")}</CardTitle>
            <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
              ...
              <DialogContent>
                <DialogHeader>
                  <DialogTitle>
                    {editingSubcategory ? t("admin.editSubcategory") : t("admin.newSubcategory")}
                  </DialogTitle>
                </DialogHeader>
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <Button type="submit" className="w-full">
                    {editingSubcategory ? t("common.save") : t("common.add")}
                  </Button>
                </form>
              </DialogContent>
            </Dialog>
